    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h3><i class="bi bi-list-check"></i> Data Pemeriksaan Metal Detector</h3>
                <a href="{{ route('metal.recyclebin') }}" class="btn btn-secondary btn-sm">
                    <i class="bi bi-trash"></i> Recycle Bin
                </a>
            </div>

            {{-- Filter dan Live Search --}}
            <form id="filterForm" method="GET" action="{{ route('metal.verification') }}" class="d-flex flex-wrap align-items-center gap-2 mb-3 p-2 border rounded bg-light shadow-sm">
                    ...
                    <tbody id="tableBody">
                        ...
                        <tr>
                                    ...
                                    <div class="modal-dialog" style="max-width: 50%;">
                                        <div class="modal-content">
                                            <div class="modal-header bg-info text-white">
                                                <h5 class="modal-title text-start" id="pemeriksaanModalLabel{{ $dep->uuid }}">Detail Pemeriksaan Metal Detector</h5>
                                                    ...
                                                    <table class="table table-bordered table-striped table-sm text-center align-middle">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>{{ $item['pukul'] ?? '-' }}</td>
                                                                <td>
                                                                    {!! (isset($item['fe']) && $item['fe'] === 'Oke') ? '✅' : ($item['fe'] ?? '-') !!}
                                                                </td>
                                                                <td>
                                                                    {!! (isset($item['non_fe']) && $item['non_fe'] === 'Oke') ? '✅' : ($item['non_fe'] ?? '-') !!}
                                                                </td>
                                                                <td>
                                                                    {!! (isset($item['sus_316']) && $item['sus_316'] === 'Oke') ? '✅' : ($item['sus_316'] ?? '-') !!}
                                                                </td>
                            ...
                            <td class="text-center align-middle">
                                ...
                                <form action="{{ route('metal.destroy', $dep->uuid) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
...
<form method="GET" action="{{ route('metal.exportPdf') }}">
