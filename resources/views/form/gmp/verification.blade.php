    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="{{ route('gmp.recyclebin') }}" class="btn btn-secondary btn-sm">
            ...
            @empty
            <tr>
                <td colspan="19" class="text-center align-middle">Belum ada data gmp karyawan.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
        ...
        <form action="{{ route('gmp.export') }}" method="GET" class="row g-2 align-items-center">
            ...
            <div class="col-auto">
                <select id="atribut" name="atribut" class="form-control form-control-sm" required>
                    ...
                    <option value="noodle_rice" {{ request('atribut') == 'noodle_rice' ? 'selected' : '' }}>Noodle Rice</option>
                    <option value="cooking" {{ request('atribut') == 'cooking' ? 'selected' : '' }}>Cooking</option>
                    <option value="packing" {{ request('atribut') == 'packing' ? 'selected' : '' }}>Packing</option>
                </select>
            </div>
