...
<div class="container-fluid py-0">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <form id="filterForm" method="GET" action="{{ route('verifikasi_sanitasi.verification') }}" class="d-flex flex-wrap align-items-center gap-2 mb-3 p-2 border rounded bg-light shadow-sm">
                            ...
                            <td class="text-center align-middle">
                                ...
                                <div class="modal fade" id="verifyModal{{ $dep->uuid }}" tabindex="-1" aria-labelledby="verifyModalLabel{{ $dep->uuid }}" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-md">
                                        <form action="{{ route('verifikasi_sanitasi.verification.update', $dep->uuid) }}" method="POST">
                                            @csrf
                                            @method('PUT')
...
<form method="GET" action="{{ route('verifikasi_sanitasi.exportPdf') }}">
