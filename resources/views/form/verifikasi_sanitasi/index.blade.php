    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h3><i class="bi bi-list-check"></i> Data Verifikasi Sanitasi</h3>
                <a href="{{ route('verifikasi_sanitasi.create') }}" class="btn btn-success">
                    <i class="bi bi-plus-circle"></i> Tambah
                </a>
            </div>

            {{-- Filter dan Live Search --}}
            <form id="filterForm" method="GET" action="{{ route('verifikasi_sanitasi.index') }}" class="d-flex flex-wrap align-items-center gap-2 mb-3 p-2 border rounded bg-light shadow-sm">
            ...
            <div class="table-responsive">
                <table class="table table-striped table-bordered align-middle">
                    ...
                    <tbody id="tableBody">
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                ...
                                <td class="text-center">
                                    <a href="{{ route('verifikasi_sanitasi.edit', $dep->uuid) }}" class="btn btn-warning btn-sm me-1">
                                        <i class="bi bi-pencil"></i> Edit
                                    </a>
                                    <form action="{{ route('verifikasi_sanitasi.destroy', $dep->uuid) }}" method="POST" class="d-inline">
                                        @csrf
                                        @method('DELETE')
                        ...
                        @empty
                        <tr>
                            <td colspan="11" class="text-center">Belum ada data verifikasi sanitasi.</td>
                        </tr>
                        @endforelse
                    </tbody>
                </table>
