    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="{{ route('iqf.recyclebin') }}" class="btn btn-secondary btn-sm">
            ...
            <form id="filterForm" method="GET" action="{{ route('iqf.verification') }}" class="d-flex flex-wrap align-items-center gap-2 mb-3 p-2 border rounded bg-light shadow-sm">
                        ...
                        <td class="text-center align-middle">
                            ...
                            <div class="modal fade" id="verifyModal{{ $dep->uuid }}" tabindex="-1" aria-labelledby="verifyModalLabel{{ $dep->uuid }}" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-md">
                                    <form action="{{ route('iqf.verification.update', $dep->uuid) }}" method="POST">
                                        @csrf
                                        @method('PUT')
