...
<div class="container-fluid py-0">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <form id="filterForm" method="GET" action="{{ route('suhu.verification') }}" class="d-flex flex-wrap align-items-center gap-2 mb-3 p-2 border rounded bg-light shadow-sm">
...
<div class="card shadow-sm mb-3">
  <div class="card-body">
    <form action="{{ route('suhu.export') }}" method="GET" class="row g-2 align-items-center">
      <div class="col-auto">
  ...
  <div class="col-auto">
    <button type="submit" formaction="{{ route('suhu.exportPdf') }}" class="btn btn-danger btn-sm">
