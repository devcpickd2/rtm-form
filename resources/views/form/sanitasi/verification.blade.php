    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h3><i class="bi bi-list-check"></i> Data Pemeriksaan Sanitasi</h3>
                <a href="{{ route('sanitasi.recyclebin') }}" class="btn btn-secondary btn-sm">
                    <i class="bi bi-trash"></i> Recycle Bin
                </a>
            </div>

            {{-- Filter dan Live Search --}}
            <form id="filterForm" method="GET" action="{{ route('sanitasi.verification') }}" class="d-flex flex-wrap align-items-center gap-2 mb-3 p-2 border rounded bg-light shadow-sm">
                ...
                <table class="table table-striped table-bordered align-middle">
                    ...
                    <tbody id="tableBody">
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">{{ $dep->std_footbasin }}</td>
                            <td class="text-center align-middle">
                                @if($dep->aktual_footbasin)
                                <a href="{{ asset('storage/' . $dep->aktual_footbasin) }}" target="_blank">
                                    <img src="{{ asset('storage/' . $dep->aktual_footbasin) }}" alt="Foot Basin"
                            ...
                            <td class="text-center align-middle">{{ $dep->std_handbasin }}</td>
                            <td class="text-center align-middle">
                                @if($dep->aktual_handbasin)
                                <a href="{{ asset('storage/' . $dep->aktual_handbasin) }}" target="_blank">
                                    <img src="{{ asset('storage/' . $dep->aktual_handbasin) }}" alt="Hand Basin"
                                    style="max-width:100px; height:auto; cursor:pointer;">
                                </a>
                                @else
                                -
        ...
        @empty
        <tr>
            <td colspan="19" class="text-center align-middle">Belum ada data sanitasi.</td>
        </tr>
        @endforelse
    </tbody>
</table>
...
<form method="GET" action="{{ route('sanitasi.exportPdf') }}">
