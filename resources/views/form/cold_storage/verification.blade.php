    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h3><i class="bi bi-list-check"></i> Data Pemantauan Suhu Produk di Cold Storage</h3>
                <a href="{{ route('cold_storage.recyclebin') }}" class="btn btn-secondary btn-sm">
                    <i class="bi bi-trash"></i> Recycle Bin
                </a>
            </div>

            {{-- Filter dan Live Search --}}
            <form id="filterForm" method="GET" action="{{ route('cold_storage.verification') }}" class="d-flex flex-wrap align-items-center gap-2 mb-3 p-2 border rounded bg-light shadow-sm">
                    ...
                    <tbody id="tableBody">
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">
                                ...
                                @if(!empty($suhu_cs))
                                <a href="#" data-bs-toggle="modal" data-bs-target="#suhuModal{{ $dep->uuid }}" style="font-weight: bold; text-decoration: underline;">
                                    Lihat Suhu Produk
                                </a>
                            ...
                            <div class="modal fade" id="verifyModal{{ $dep->uuid }}" tabindex="-1" aria-labelledby="verifyModalLabel{{ $dep->uuid }}" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-md">
                                    <form action="{{ route('cold_storage.verification.update', $dep->uuid) }}" method="POST">
                                        @csrf
                                        @method('PUT')
