                ...
                <div class="card-body table-responsive">
                    ...
                    <table class="table table-bordered table-sm text-center align-middle" id="thumblingTable">
                        ...
                        <tbody>
                            ...
                            <tr><td class="text-left">Suhu Air</td><td colspan="4"><input type="number" step="0.01" name="suhu_air" class="form-control" value="{{ old('suhu_air', $thumbling->suhu_air) }}"></td></tr>
                            <tr><td class="text-left">Suhu Marinade</td><td colspan="4"><input type="number" step="0.01" name="suhu_marinade" class="form-control" value="{{ old('suhu_marinade', $thumbling->suhu_marinade) }}"></td></tr>
                            ...
                            <tr><td class="text-left align-middle">Drum On (Menit)</td><td colspan="4"><input type="number" name="drum_on" class="form-control" value="{{ old('drum_on', $thumbling->drum_on) }}" step="0.01"></td></tr>
                            <tr><td class="text-left align-middle">Drum Off (Menit)</td><td colspan="4"><input type="number" name="drum_off" class="form-control" value="{{ old('drum_off', $thumbling->drum_off) }}" step="0.01"></td></tr>
                            <tr><td class="text-left align-middle">Drum Speed (RPM)</td><td colspan="4"><input type="number" name="drum_speed" class="form-control" value="{{ old('drum_speed', $thumbling->drum_speed) }}" step="0.01"></td></tr>
                            <tr><td class="text-left align-middle">Vacuum Time</td><td colspan="4"><input type="number" name="vacuum_time" class="form-control" value="{{ old('vacuum_time', $thumbling->vacuum_time) }}" step="0.01"></td></tr>
                            <tr><td class="text-left align-middle">Total Time</td><td colspan="4"><input type="number" name="total_time" class="form-control" value="{{ old('total_time', $thumbling->total_time) }}" step="0.01"></td></tr>

                            <tr>
                                <td class="text-left align-middle">Mulai – Selesai</td>
                                <td colspan="2"><input type="time" name="waktu_mulai"
                                   class="form-control"
                                   value="{{ old('waktu_mulai', \Carbon\Carbon::parse($thumbling->waktu_mulai)->format('H:i')) }}"></td>
                                   <td colspan="2"><input type="time" name="waktu_selesai"
                                     class="form-control"
                                     value="{{ old('waktu_selesai', \Carbon\Carbon::parse($thumbling->waktu_selesai)->format('H:i')) }}"></td>
                                 </tr>
...
<script>
    ...
    let bahanIndex = {{ count($thumbling->bahan_lain ?? [0]) }}; 
