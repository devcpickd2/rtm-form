    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h3><i class="bi bi-list-check"></i> Data Pemeriksaan Disposisi Produk tidak Sesuai</h3>
                <a href="{{ route('disposisi.recyclebin') }}" class="btn btn-secondary btn-sm">
                    <i class="bi bi-trash"></i> Recycle Bin
                </a>
            </div>
            
            {{-- Filter dan Live Search --}}
            <form id="filterForm" method="GET" action="{{ route('disposisi.verification') }}" class="d-flex flex-wrap align-items-center gap-2 mb-3 p-2 border rounded bg-light shadow-sm">
                ...
                <table class="table table-striped table-bordered align-middle">
                    <thead class="table-primary text-center">
                        <tr>
                            ...
                            <th>Tindakan Terhadap Produk</th>
                            <th>Catatan</th>
                            <th>QC</th>
                            <th>Produksi</th>
                            <th>SPV</th>
                    ...
                    <tbody id="tableBody">
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">{{ $dep->ketidaksesuaian ?: '-' }}</td>
                            <td class="text-center align-middle">{{ $dep->tindakan ?: '-' }}</td>
                            ...
                            <td class="text-center align-middle">
                                ...
                                <form action="{{ route('disposisi.destroy', $dep->uuid) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
                            ...
                            <div class="modal fade" id="verifyModal{{ $dep->uuid }}" tabindex="-1" aria-labelledby="verifyModalLabel{{ $dep->uuid }}" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-md">
                                    <form action="{{ route('disposisi.verification.update', $dep->uuid) }}" method="POST">
                                        @csrf
                                        @method('PUT')
        ...
        @empty
        <tr>
            <td colspan="11" class="text-center align-middle">Belum ada data disposisi.</td>
        </tr>
        @endforelse
    </tbody>
</table>
...
<form method="GET" action="{{ route('disposisi.exportPdf') }}">
