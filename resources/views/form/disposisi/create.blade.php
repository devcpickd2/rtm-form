...
<div class="container-fluid py-4">
    <div class="card shadow-sm">
        <div class="card-body"> 
            <h4><i class="bi bi-plus-circle"></i> Form Input Pemeriksaan Disposisi Produk tidak Sesuai</h4>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <textarea name="tindakan" class="form-control" placeholder="Tuliskan Tindakan terhadap Produk"></textarea>
                </div>
                <div class="card-header bg-light">
