    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="{{ route('premix.recyclebin') }}" class="btn btn-secondary btn-sm">
                    <i class="bi bi-trash"></i> Recycle Bin
                </a>
            </div>
            {{-- Filter dan Live Search --}}
            <form id="filterForm" method="GET" action="{{ route('premix.verification') }}" class="d-flex flex-wrap align-items-center gap-2 mb-3 p-2 border rounded bg-light shadow-sm">
                ...
                <table class="table table-striped table-bordered align-middle">
                    ...
                    <tbody id="tableBody">
                        ...
                        <tr>
                            ...
                            <td class="text-center align-middle">{{ $dep->nama_premix }}</td>
                            ...
                            <td class="text-center align-middle">
                                ...
                                <div class="modal fade" id="verifyModal{{ $dep->uuid }}" tabindex="-1" aria-labelledby="verifyModalLabel{{ $dep->uuid }}" aria-hidden="true">
                                    <div class="modal-dialog modal-dialog-centered modal-md">
                                        <form action="{{ route('premix.verification.update', $dep->uuid) }}" method="POST">
                                            @csrf
                                            @method('PUT')
            ...
            @empty
            <tr>
                <td colspan="19" class="text-center align-middle">Belum ada data premix.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
...
<form method="GET" action="{{ route('premix.exportPdf') }}">
