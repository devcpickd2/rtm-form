    ...
    <div class="card shadow-sm">
        <div class="card-body">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="{{ route('sekunder.create') }}" class="btn btn-success">
                    <i class="bi bi-plus-circle"></i> Tambah
                </a>
            </div>

            {{-- Filter dan Live Search --}}
            <form id="filterForm" method="GET" action="{{ route('sekunder.index') }}" class="d-flex flex-wrap align-items-center gap-2 mb-3 p-2 border rounded bg-light shadow-sm">
                    ...
                    <tbody id="tableBody">
                        ...
                        <tr>
                            ...
                            <!-- <td class="text-center align-middle">
                                @if ($dep->status_checker == 0)
                                <span class="fw-bold text-secondary">Created</span>
                                @elseif ($dep->status_checker == 1)
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <ul class="list-unstyled mb-0">
                                                        ...
                                                        <li><strong>Nama Checker:</strong> {{ $dep->nama_checker ?? '-' }}</li>
                                                    </ul>
                                                </div>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('sekunder.edit', $dep->uuid) }}" class="btn btn-warning btn-sm me-1">
                            ...
                            @empty
                            <tr>
                                <td colspan="12" class="text-center">Belum ada data sekunder.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
