...
<div class="container-fluid py-0">
    ...
    <div class="card shadow-sm">
        <div class="card-body">
            ...
            <form id="filterForm" method="GET" action="{{ route('pemusnahan.index') }}" class="d-flex flex-wrap align-items-center gap-2 mb-3 p-2 border rounded bg-light shadow-sm">
